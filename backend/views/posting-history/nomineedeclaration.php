 ...
 $this->title = Yii::t('app', 'NOMINEE DECLARATION FORM 1');
...
<div class="container">
    <?php $form = ActiveForm::begin(['action' => ['posting-history/nomineedeclaration'], 'options' => ['enctype' => 'multipart/form-data', 'class' => 'homeform']]); ?>
    ...
    if ($posting_details) {
     foreach ($posting_details as $posting_detail) {
       ...
       <div style="width:100%; padding:10px;margin:auto;line-height: 1.5; margin-top:50px; border:1px solid #dedede;">
                            <h3>
                                <span style="font-weight:normal; font-size:13px;">FORM-1 <br> <strong>NOMINATION AND DECLARATION FORM   </strong><br>
                                [See Rule 3]<br></span>
                            </h3>
                            <table class="table" style="width:96%;font-size: 10px;margin:2%;">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td style="border: none;">  Permanent :</td>
                                    <td><?= $posting_detail->enrolement->permanent_addrs ?? ''?></td>
                                </tr>
                                 <tr>
