...
$this->title = Yii::t('app', 'PF - MONTHLY PF STATEMENT');
...
<?php $form = ActiveForm::begin([ 'options' => ['enctype' => 'multipart/form-data', 'class' => 'homeform','id'=>'pf_monthly_report_form']]); ?>
<div class="row">
  <div class="col-md-2">
    ...
    <div class="col-md-2">
      <div class="form-group field-client">
      <button type="button" id="pf_monthly_report" class="float-left btn btn-success"><span class='fa fa-download' aria-hidden='true'> Download PF  Monthly Report</span></button>
...
<script>
  ...
  $("#pf_monthly_report").click(function(){
        ...
        if(confirm("Do you want to Download PF Monthly Report!")){
          $.ajax({
            data:{
                "plant_id": plant_id,
                'po_id': po_id,
            ...
            type: "post",
            url: "<?=Url::to(['salary/download_pt_monthly_pt_stmt'])?>",
